package com.example.video_call_app.activities;
...
import com.example.video_call_app.adapters.UsersAdapter;
...
import com.example.video_call_app.utilities.PreferenceManager;
...
public class MainActivity extends AppCompatActivity implements UsersListener {
    ...
    public void initiateVideoCall(User user) {
        ...
        if (!isValidToken) {
            Toast.makeText(this, user.firstName + " " + user.lastName + " is not available for call", Toast.LENGTH_SHORT).show();
        } else {
